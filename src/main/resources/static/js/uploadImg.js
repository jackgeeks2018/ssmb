        ...
        $.ajax({
            ...
            success: function(dat) {
                ...
                if(data.resultFlag=="1"){
                    ...
                    InitWorkerTable("/webRestful/getWorkerListReq");
                    closeDate();
                    $("#showTip").removeClass("hide");
                    $("#showTip span").html(data.msg);
                    setTimeout(function () {
                        $("#showTip").addClass("hide");
                    },800);
                }else{
                    $("#showTip").removeClass("hide");
                    $("#showTip span").html(data.msg);
...
function imgDisplay(obj) {
    ...
    var imgHtml = '<div style="width: 100%;height: 100vh;overflow: auto;background: rgba(0,0,0,0.5);text-align: center;position: fixed;top: 0;left: 0;z-index: 999999;"><img src=' + src + ' style="margin-top: 100px;width: 30%;margin-bottom: 100px;"/><p style="font-size: 50px;position: fixed;top: 30px;right: 30px;color: white;cursor: pointer;" onclick="closePicture(this)">×</p></div>'
    $('body').append(imgHtml);
}
//关闭
